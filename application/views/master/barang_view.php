                          ...
                          <div class="body">                              
                                  <div class="form-group form-float">
                                      <div class="form-line disabled">
                                          <input type="text" id="kode_barang" name="kode_barang" class="form-control" disabled>
                                 ...
                                 <div class="form-group form-float">
                                      <div class="form-line">
                                          <input type="number" id="warna_barang" name="warna_barang" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                              <input type="hidden" name="satuan" hidden>
                                              <div id="dropdownSatuan">
...
//=============> PREPARE DATA
            ...
            var dtSatuan =  {
                ...
                {name :'keterangan_satuan', type: 'string'}],
                id: 'kode_pemasok',
                url:'<?php echo base_url()?>Master/ShowDataSatuan',
                async: false
            }
            ...
            var dtPemasok =  {
                datatype: "json",
                datafields: [
                {name :'kode_pemasok', type: 'string'}, 
                {name :'nama_pemasok', type: 'string'}, 
            ...
            var dtSatuanAdapter = new $.jqx.dataAdapter(dtSatuan, { autoBind: true });
            var dtPemasokAdapter = new $.jqx.dataAdapter(dtPemasok,  { autoBind: true }); 
            conKategori = dtKategoriAdapter; conPemasok = dtPemasokAdapter; conSatuan = dtSatuanAdapter;


 //===========> GridSelectKategori
        var btnOkKategori =function(){
         ...
         $("#SelectKategori").jqxGrid({
              ...
              columns : [
                ...
                {text:'Keterangan', datafield:'keterangan_kategori', cellsalign:'center', align:'center'},
                ],
         });
         btnOkKategori();
         ...
         //===========> GridSelectSatuan
        var btnOkSatuan = function(){
            var element = $("<div style='float: right; margin-right:10px  margin-top:2px' ></div>");
            var okbtn = $("<div style='padding: 0px; float: left; margin-right: 10px;'><div style='margin-left: 7px; width: 16px; height: 16px;'>OK</div></div>");
            okbtn.width(36);
            okbtn.jqxButton({ theme: 'bootstrap', template:'primary' });
            okbtn.appendTo(element);
            $("#pagerSelectSatuan").children().children().last('div').remove();  
            element.appendTo($("#pagerSelectSatuan").children());
            okbtn.click(function(){
                $("#dropdownSatuan").jqxDropDownButton('close');
            });
        }
        $("#SelectSatuan").jqxGrid({
              source : dtSatuanAdapter,
              width: 250,
              theme: 'bootstrap',
              columnsresize: true,
              pageable: true,    
              ...
              autoheight: true, 
              columns : [
                {text:'Kode Satuan', datafield:'kode_satuan', cellsalign:'center', align:'center'/*pinned:'true'*/},
                {text:'Nama Satuan', datafield:'nama_satuan', cellsalign:'center', align:'center'},
                {text:'Keterangan', datafield:'keterangan_satuan', cellsalign:'center', align:'center'},
                ],
         });
         btnOkSatuan();
         $("#dropdownSatuan").jqxDropDownButton({width: '100%', height:25});
         $("#SelectSatuan").on('rowselect', function(event){
            var args = event.args;
            var row = $('#SelectSatuan').jqxGrid('getrowdata', args.rowindex);
            var content = '<div style="position: relative; margin-left:3px; margin-top: 5px;">' + row['nama_satuan'] +'</div>';
            $("#dropdownSatuan").jqxDropDownButton('setContent', content);
            $('input[name=kode_satuan]').val(row['kode_satuan']);
         }); 
         var TempContentSatuan = '<div style="position: relative; margin-left:3px; margin-top: 5px;">' + 'Pilih Satuan' +'</div>';
         $("#dropdownSatuan").jqxDropDownButton('setContent', TempContentSatuan);

        //===========> GridSelectPemasok
        var btnOkPemasok = function(){
            var element = $("<div style='float: right; margin-right:10px  margin-top:2px' ></div>");
            var okbtn = $("<div style='padding: 0px; float: left; margin-right: 10px;'><div style='margin-left: 7px; width: 16px; height: 16px;'>OK</div></div>");
            okbtn.width(36);
            okbtn.jqxButton({ theme: 'bootstrap', template:'primary' });
        ...
        $("#SelectPemasok").jqxGrid({
         ...
         $("#dropdownPemasok").jqxDropDownButton('setContent', TempContentPemasok);
            ...
            var dtBarang = 
            {
              ...
              url:'<?php echo base_url()?>Master/ShowJoinDataBarang',
            ...
            $("#GridBarang").jqxGrid({
              ...
              columns : [
                ...
                {text:'Satuan', datafield:'kode_satuan', cellsalign:'center', align:'center', },
                {text:'Warna', datafield:'warna_barang', cellsalign:'center', align:'center' },
